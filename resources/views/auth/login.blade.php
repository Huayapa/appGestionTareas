<x-guest-layout>
    ...
    <div class="flex justify-center items-center w-full lg:gap-24">
        <div class="hidden md:block relative">
            ...
            <img src="{{ asset('img/coffee.png') }}" alt="Café" class="animate-beat absolute bottom-[100px] right-[100px]">
            <img src="{{ asset('img/calendar.png') }}" alt="Calendario" class="animate-beat-reverse absolute top-1/4 right-20">
            <img src="{{ asset('img/vase.png') }}" alt="Jarrón" class="animate-beat absolute bottom-[60px] left-[40px]">
        </div>
