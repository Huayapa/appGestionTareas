<nav class="grid grid-cols-3 sm:hidden fixed bottom-0 left-0 w-full bg-tertiary">
    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
        <div class="w-9 aspect-square">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z" fill="#42C83C"
                    stroke="#42C83C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <button class="bg-primary shadow-xl shadow-[#42C83C50] flex items-center justify-center rounded-full absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 aspect-square w-16" x-data="" x-on:click.prevent="$dispatch('open-modal', 'create-new-task')">
    ...
    <x-nav-link class="col-start-3" :href="route('dashboard')" :active="request()->routeIs('dashboard')">
