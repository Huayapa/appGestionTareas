<nav class="bg-dark hidden md:flex rounded-xl">
    <!-- Primary Navigation Menu -->
    <div class="flex flex-col justify-between sticky top-0 w-full">
        ...
        <form method="POST" action="{{ route('logout') }}" class="pb-6 px-5">
            @csrf
